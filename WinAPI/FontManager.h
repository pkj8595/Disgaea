...
public:
	...
	void drawText(HDC hdc, RECT rangeRect, char* fontName, int fontSize, int fontWidth, string printString,COLORREF color,bool isLeft);
	...
	void drawTextRectCenter(HDC hdc, RECT rangeRect, char* fontName, int fontSize, int fontWidth, string printString, COLORREF color);
